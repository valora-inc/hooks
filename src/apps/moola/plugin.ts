import { AppPlugin, AppTokenPositionDefinition, TokenDefinition } from '../../plugin'
...
const debtTokensInfo: DebtTokensInfo[] = [
  {
    ...
    imageUrl: 'https://raw.githubusercontent.com/ubeswap/default-token-list/master/assets/mcEUR.png',
...
function getTokenDefinitionFromInfo(tokenDefinition: TokenDefinition, debtTokenInfo: DebtTokensInfo): AppTokenPositionDefinition {
  return {
...
const plugin: AppPlugin = {
  ...
  async getPositionDefinitions(network, address) {
    ...
    return debtTokensInfo
      ...
      .map(debtTokenInfo => getTokenDefinitionFromInfo({ address: debtTokenInfo.tokenAddress, network }, debtTokenInfo))
  },
